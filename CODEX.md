...
5. **Every controller action MUST have a complete `#[OA\...]` PHP Attribute annotation** — the CI `swagger.yml`
   ...
   - Add `use OpenApi\Attributes as OA;` to every controller that uses annotations
   - **Never** use the old `/** @OA\... */` docblock syntax — the project has migrated to PHP 8 Attributes
